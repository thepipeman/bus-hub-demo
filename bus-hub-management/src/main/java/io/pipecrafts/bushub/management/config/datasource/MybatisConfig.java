package io.pipecrafts.bushub.management.config.datasource;
...
@MapperScan(
  basePackages = {"io.pipecrafts.bushub.management"},
...
class MybatisConfig implements ResourceLoaderAware {
  ...
  private static Resource[] getMybatisMapperFiles(ResourceLoader resourceLoader) {
    ...
    try {
      ...
      mapperLocations = resourceResolver.getResources("classpath*:io.pipecrafts.bushub.management/**/*Mapper.xml");
